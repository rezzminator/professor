...
- An Xvfb display on `:99` for the ladder's headed retry after a wall, real fonts, and 2 GB of `/dev/shm`. Docker's 64 MB default crashes renderers on heavy pages.
