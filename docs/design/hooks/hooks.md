...
| rr-dir | `SubagentStart` | `rr\|super-rr\|heavy-rr` | `pfm internal rr-dir` | `expected_hooks.go:96-101` | `pfm/internal/hookentry/rr_dir.go:27-31` | Hands the rr agents the directory their answer is saved into | Fail-open, exits 0 (`rr_dir.go:45-47`) |
