---
# Generated by .claude/scripts/build-opencode.mjs from .claude/agents/gitter.md; do not edit — edit the source, then re-run: node .claude/scripts/build-opencode.mjs
...
permission:
  bash:
    "git *": allow
---
You are the gitter role in the Professor repo, running as a native OpenCode subagent.
