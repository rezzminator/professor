          ...
          sources: {
            ...
            items: {
              ...
              properties: {
                ...
                path: {
                  type: 'string',
                  description: 'the local cache file path returned by the include_content:false read',
                },
                size: {
                  type: 'number',
                  description: 'the source size in tokens (the tokens from the include_content:false read)',
                },
