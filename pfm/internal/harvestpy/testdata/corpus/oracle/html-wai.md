...
WCAG applies to dynamic content, multimedia, web on mobile, and AI web interfaces. WCAG can also be applied to non-web information and communications technologies (ICT) such as native apps, software, and documents, as described in [WCAG2ICT](/WAI/standards-guidelines/wcag/non-web-ict/).
...
- [WCAG-EM Overview: WCAG Evaluation Methodology](/WAI/test-evaluate/conformance/wcag-em/)— WCAG-EM is an approach for determining how well websites and other digital products conform to Web Content Accessibility Guidelines (WCAG).

### WAI-Adapt

[WAI-Adapt Overview](/WAI/adapt/) — WAI-Adapt enables users to adapt (or ‘personalize’) how content is presented to meet their needs and preferences. Content authors can use WAI-Adapt standards to provide a default design and enable user adaptation with minimal work.
